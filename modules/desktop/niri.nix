{
  ...
  perSystem = {
    ...
    mako-rs = inputs.mako-rs.packages.${pkgs.stdenv.hostPlatform.system}.default;
  in {
    packages.mako-rs = mako-rs;
    ...
    packages.myNiri = inputs.wrapper-modules.wrappers.niri.wrap {
      ...
      settings = {
        spawn-at-startup = [
          ...
          [(lib.getExe pkgs.awww) "${./assets/catppuccin-macchiato-wallpaper.png}"]
          "${mako-rs}/bin/mako-rs"
        ];
